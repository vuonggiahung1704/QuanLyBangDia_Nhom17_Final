...
public class Main extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jLabel2.setFont(new Font("Tahoma", Font.PLAIN, 24));
		...
		jLabel1.setFont(new Font("Tahoma", Font.BOLD, 26)); // NOI18N
		jLabel1.setForeground(new java.awt.Color(255, 255, 255));
		jLabel1.setText("Hệ thống quản lý cho thuê băng đĩa");
		...
		jPanel4Layout.setHorizontalGroup(
			jPanel4Layout.createParallelGroup(Alignment.LEADING)
				.addGroup(jPanel4Layout.createSequentialGroup()
					.addContainerGap()
					.addComponent(jLabel1, GroupLayout.PREFERRED_SIZE, 571, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED, 536, Short.MAX_VALUE)
					.addComponent(jLabel2, GroupLayout.PREFERRED_SIZE, 363, GroupLayout.PREFERRED_SIZE)
					.addContainerGap())
		);
	...
	public void khoiTaoPanel() {
		...
		dia_pn = new gui_danhMuc.Dia_Gui();
	...
	public static void setNhanVien(TaiKhoan tk_sql) {
		...
		jLabel2.setText("Tài khoản: "+tk.getHoTen());
	...
	public static gui_danhMuc.Dia_Gui dia_pn;
