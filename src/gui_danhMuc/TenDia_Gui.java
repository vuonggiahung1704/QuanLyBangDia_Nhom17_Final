...
public class TenDia_Gui extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		jTableTenDia.setRowHeight(40);
		jTableTenDia.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		jTableTenDia.setFont(new java.awt.Font("Times New Roman", 0, 26)); // NOI18N
					...
					.addGroup(layout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(layout.createSequentialGroup()
							.addGroup(layout.createParallelGroup(Alignment.TRAILING)
								.addComponent(jPanel2, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 1465, Short.MAX_VALUE)
								.addGroup(layout.createSequentialGroup()
	...
	public void DocDuLieuDatabaseVaoTable(String txt) {
		dm = (DefaultTableModel) jTableTenDia.getModel();
		dm.setRowCount(0);
