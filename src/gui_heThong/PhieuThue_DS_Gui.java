...
public class PhieuThue_DS_Gui extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		setPreferredSize(new Dimension(1274, 605));
			...
			layout.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, layout.createSequentialGroup()
					...
					.addGroup(layout.createParallelGroup(Alignment.TRAILING)
						.addComponent(jPanel4, GroupLayout.DEFAULT_SIZE, 1244, Short.MAX_VALUE)
						.addGroup(layout.createSequentialGroup()
							.addComponent(txtTim, GroupLayout.PREFERRED_SIZE, 418, GroupLayout.PREFERRED_SIZE)
							...
							.addComponent(btnLapPhieuThue1, GroupLayout.PREFERRED_SIZE, 201, GroupLayout.PREFERRED_SIZE)))
					.addContainerGap())
		);
					...
					.addGroup(layout.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(layout.createSequentialGroup()
							.addGroup(layout.createParallelGroup(Alignment.TRAILING, false)
								...
								.addComponent(btnLapPhieuThue1, Alignment.LEADING)
								.addComponent(btnTim1, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE))
							.addGap(16)))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(jPanel4, GroupLayout.DEFAULT_SIZE, 512, Short.MAX_VALUE)
					.addContainerGap())
		);
	...
	public void DocDuLieuDatabaseVaoTable(String txt, int tim) {
		dm = (DefaultTableModel) jTableKhachHang.getModel();
		dm.setRowCount(0);
	...
	private Main main;
	private static KhachHang_DAO qlkh;
	private static PhieuThue_DAO qlpt;
	private static TaiKhoan_DAO qltk;
	private String maPT;
